namespace GoEng.Settings
{
    public class ErrorSettings
    {
        ...
        public const string IncorrectLoginOrPass = "Login or password are wrong.";
        public const string RegisterErrorMessage = "Your information are wrong, please try again.";
        ...
        public const string RegisterErrorMessage_InvalidPassword = "Password is not correct.";
